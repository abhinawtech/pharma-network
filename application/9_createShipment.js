...
async function main(organisation,buyerCRN, drugName, listOfAssets, transporterCRN) {
	...
	try {
		...
		let newShipment = JSON.parse(createShipmentBuffer.toString());
...
var connectionProfile;
 ...
 /*main('Transporter','CRN0002', 'Parace','D10001','1','CRN0004').then(() => {
