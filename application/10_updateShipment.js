...
async function main(organisation,buyerCRN, drugName, transporterCRN) {
	...
	try {
		...
		let newUpdateShipment = JSON.parse(updateShipmentBuffer.toString());
...
/* main('Transporter','CRN0002', 'D10001','CRN0004').then(() => {
